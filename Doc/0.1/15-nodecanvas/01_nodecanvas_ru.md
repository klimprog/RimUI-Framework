...
[Оглавление](../index_ru.md) - NodeCanvas | Пред.: [HeatmapChart](../14-charts/07_heatmapchart_ru.md) | [English](01_nodecanvas_en.md)
...
|---|---|---|
| `Serialize()` | `string` | Сериализовать `Nodes`/`Links` в плоский JSON. |
