...
`Style.AutoHeight = true` makes a row fit its content: text wraps and the row grows as far as it
needs to, instead of being cut off at a fixed height. The row height you set then acts as a
minimum.
